...
class Recommendation:
    def __init__(self, nutrition_list, num_recommendations, ingredient_txt):
        self.nutrition_list = nutrition_list
        self.num_recommendations = num_recommendations
        self.ingredient_txt = ingredient_txt

    def generate(self):
        params = {'n_neighbors': self.num_recommendations, 'return_distance': False}
...
with st.form("recommendation_form"):
    ...
    num_recommendations = st.slider('Number of recommendations', 5, 20, step=5)
...
if generated:
    with st.spinner('Generating recommendations...'):
        recommendation = Recommendation(nutritions_values_list, num_recommendations, ingredient_txt)
